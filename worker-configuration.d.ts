...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DISPATCH_NAMESPACE: "vibeship-default-namespace";
		ARTIFACTS_NAMESPACE: "vibeship-production";
		...
		// Vibeship billing (Stripe). Всички са незадължителни — без тях
		// платените планове просто не са налични.
