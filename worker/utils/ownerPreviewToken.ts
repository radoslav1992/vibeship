...
export const OWNER_PREVIEW_QUERY_PARAM = '__vibeship_owner';
export const OWNER_PREVIEW_COOKIE_NAME = '__vibeship_owner';
...
/** Read the owner-preview token from the `?__vibeship_owner=` query param. */
