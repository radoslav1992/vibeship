...
export const queryKeys = {
	...
	account: {
		...
		billing: {
			all: () => [...queryKeys.account.all, 'billing'] as const,
			summaryAll: () => [...queryKeys.account.billing.all(), 'summary'] as const,
			summary: (userId?: string | null) =>
				[
					...queryKeys.account.billing.summaryAll(),
					userId ?? 'anonymous',
				] as const,
			plans: () => [...queryKeys.account.billing.all(), 'plans'] as const,
		},
		limits: {
