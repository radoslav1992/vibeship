                    ...
                    {showConflictWarning && remoteStatus && remoteStatus.aheadBy > 0 ? (
                        ...
                        exportResult.success ? (
                            ...
                            <StatusMessage
                                ...
                                title="Export Failed"
                                message={exportResult.error || 'Възникна грешка при изпращането'}
                            >
                                <div className="space-x-2">
                                    <button
                        ...
                        <div className="py-8">
                            <div className="text-center mb-6">
                                ...
                                <h3 className="text-lg font-semibold text-text-primary mb-2">Изпращане в GitHub</h3>
                            ...
                            {mode !== 'sync' && (
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Кратко описание на приложението…"
                                        rows={3}
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        <label className="flex items-center gap-3 p-3 bg-kumo-elevated rounded-lg cursor-pointer hover:bg-border transition-colors">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-text-secondary">Публично</p>
                                                <p className="text-xs text-text-primary/60">Всеки може да види това репо</p>
                                            </div>
                                        </label>
                                        <label className="flex items-center gap-3 p-3 bg-kumo-elevated rounded-lg cursor-pointer hover:bg-border transition-colors">
                                            <input
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-text-secondary">Частно</p>
                                                <p className="text-xs text-text-primary/60">Само ти виждаш това репо</p>
                                            </div>
                                        </label>
                                    </div>
                                </div>
